...
public class PerformanceAnalyzer
    {
        ...
        public PerformanceAnalyzer(string filePath = "inputStackTest.txt")
        {
        ...
        public (double[] dataSizes, double[] times) AnalyzePerformance()
        {
            ...
            try
            {
                ...
                {
                    // Создание нового экземпляра FileHandlerStack для каждого набора данных
                    var fileHandler = new FileHandlerStack(_ => { }); // Пустой делегат для подавления вывода
                    ...
                    times.Add(timeTracker.GetElapsedMilliseconds());
                }
            }
            catch (Exception ex)
            {
